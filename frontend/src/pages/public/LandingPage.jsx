...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050B18] overflow-hidden selection:bg-indigo-500/30 selection:text-indigo-200">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-40 bg-[#050B18]/80 backdrop-blur-md border-b border-white/5 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link to="/register" className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white rounded-xl font-bold transition-all shadow-lg shadow-indigo-500/25 flex items-center justify-center gap-2 hover:scale-105">
                Start for Free <ArrowRight size={20} />
              </Link>
              <button 
                onClick={() => setShowJoinModal(true)}
                className="w-full sm:w-auto px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 rounded-xl font-bold transition-all flex items-center justify-center gap-2"
              >
                Join with Code
              </button>
            </div>
      ...
      {/* Features */}
      <div id="features" className="py-24 bg-[#080E1C] relative border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white mb-4">Everything you need</h2>
            <p className="text-slate-400">Simple, powerful, and built for modern teams and educators.</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-indigo-500/30 transition-colors">
              ...
              <p className="text-slate-400">Launch a new VM in seconds. No complex AWS or Azure setup required. Just click and code.</p>
            </div>
            
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-cyan-500/30 transition-colors">
              ...
              <p className="text-slate-400">Host interactive workshops where every participant gets their own pre-configured environment.</p>
            </div>
            
            <div className="p-8 rounded-2xl bg-slate-900 border border-slate-800 hover:border-emerald-500/30 transition-colors">
              ...
              <h3 className="text-xl font-bold text-white mb-3">Exam Mode</h3>
              <p className="text-slate-400">Lock down internet access, disable copy-paste, and monitor participants during exams.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="pricing" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400">Join for free, upgrade to host sessions.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800">
              ...
              <p className="text-slate-400 mb-6">For participants and casual users.</p>
              ...
              <Link to="/register" className="block w-full py-3 text-center bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-bold transition-colors">
                Get Started
              </Link>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-b from-indigo-900/50 to-slate-900 border border-indigo-500/30 relative">
              <div className="absolute top-0 right-8 -translate-y-1/2 px-3 py-1 bg-gradient-to-r from-indigo-500 to-cyan-500 text-white text-xs font-bold rounded-full uppercase tracking-wider">
                Most Popular
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Pro Host</h3>
              <p className="text-indigo-200/60 mb-6">For educators and teams.</p>
              <div className="text-4xl font-bold text-white mb-8">$19 <span className="text-lg text-slate-500 font-normal">/mo</span></div>
              ...
              <Link to="/register" className="block w-full py-3 text-center bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 text-white rounded-xl font-bold transition-all shadow-lg shadow-indigo-500/25">
                Upgrade to Host
              </Link>
            </div>
          </div>
