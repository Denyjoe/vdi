  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto space-y-6 animate-fade-in pb-12">
      <div>
        ...
        <p className="text-slate-400 mt-1">Manage platform users and subscriptions</p>
      </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-700 bg-slate-900/50">
                ...
                <th className="text-center px-6 py-4 text-slate-400 font-medium">Host Status</th>
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="p-1.5 bg-slate-700/50 hover:bg-slate-600 text-slate-300 rounded-lg transition-colors border border-slate-600/50"
                            title="View Details"
                          >
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-slate-800 rounded-xl border border-slate-700 shadow-2xl w-full max-w-lg overflow-hidden">
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-700 bg-slate-900/50">
              ...
              <button onClick={() => setSelectedUser(null)} className="text-slate-400 hover:text-white transition-colors p-1">
                <X className="w-5 h-5" />
              </button>
            </div>
            <div className="p-6 space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-xl font-bold text-white">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700/50">
                  ...
                  <p className="text-sm font-medium text-white">{getPlanDetails(selectedUser).name}</p>
                </div>
                <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700/50">
                  <p className="text-xs text-slate-400 mb-1">Joined</p>
                  <p className="text-sm font-medium text-white">{formatDate(selectedUser.created_at || selectedUser.date_joined)}</p>
                </div>
              </div>
            </div>
            <div className="px-6 py-4 border-t border-slate-700 flex justify-end bg-slate-900/30">
