...
urlpatterns = [
    ...
    path('templates/isos/active-download/', wizard.AdminActiveIsoDownloadView.as_view(), name='admin-template-iso-active-download'),
    ...
    path('templates/jobs/active/', wizard.AdminActiveTemplateJobsView.as_view(), name='admin-template-jobs-active'),
